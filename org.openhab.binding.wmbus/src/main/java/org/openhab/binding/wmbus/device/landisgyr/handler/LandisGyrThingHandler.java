 ...
 */
public class LandisGyrThingHandler extends WMBusDeviceHandler<LandisGyrWMBusDevice> {

    private final Logger logger = LoggerFactory.getLogger(LandisGyrThingHandler.class);
    ...
    protected LandisGyrThingHandler(Thing thing, Map<String, RecordType> channelMapping) {
        this(thing, channelMapping, LandisGyrBindingConstants.RECORD_UNITS);
    }
