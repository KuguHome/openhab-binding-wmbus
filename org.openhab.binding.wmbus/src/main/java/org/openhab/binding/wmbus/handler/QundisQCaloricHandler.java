...
/**
 * The {@link QundisQCaloricHandler} class defines Device/thing handler for the Qundis Qcaloric 5,5 heat cost allocator
 * (Heizkostenverteiler)
 *
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        ...
        if (command == RefreshType.REFRESH) {
            ...
            if (wmbusDevice != null) {
                 ...
                 * measurement value
                 * DIB:4B, VIB:6E -> descr:HCA, function:INST_VAL, storage:1, value:000000, unit:RESERVED -- reading
                 * before previous one over last year
                 * DIB:42, VIB:6C -> descr:DATE, function:INST_VAL, storage:1, value:Sun Dec 31 00:00:00 CET 2017 --
                 * reading before previous one
                 * DIB:CB08, VIB:6E -> descr:HCA, function:INST_VAL, storage:17, value:000000, unit:RESERVED -- previous
                 * reading
                 * DIB:C208, VIB:6C -> descr:DATE, function:INST_VAL, storage:17, value:Wed Feb 28 00:00:00 CET 2018 --
                 * previous reading over last month
                 * DIB:32, VIB:6C -> descr:DATE, function:ERROR_VAL, value:Sat Sep 23 00:00:00 CEST 2017 -- time of last
                 * error
                 * DIB:04, VIB:6D -> descr:DATE_TIME, function:INST_VAL, value:Mon Mar 05 12:23:00 CET 2018 -- timestamp
                ...
                switch (channelUID.getId()) {
                    ...
                    case CHANNEL_PREVIOUSREADING: {
                        ...
                        DataRecord record = wmbusDevice.findRecord(new byte[] { (byte) 0xCB, 0x08 },
                                new byte[] { 0x6e });
                        if (record != null) {
                            newState = new DecimalType(record.getScaledDataValue());
                        } else {
